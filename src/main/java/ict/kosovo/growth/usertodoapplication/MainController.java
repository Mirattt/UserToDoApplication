...
public class MainController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        tvTodoItems.getColumns().addAll(nameColumn,descriptionColumn,colorColumn,deadlineColumn);
   ...
   /*     Dialog<ButtonType> dialog = new Dialog<>();
        ...
        dialog.setHeaderText("Ju lutem plotesoni");
        ...
        Optional<ButtonType> result = dialog.showAndWait(); //show dialog and wait */
        FXMLLoader loader = new FXMLLoader();
        Optional<ButtonType> result = GenericHelper.showDialogBoxFor("todo-create-view.fxml","New Todo Item","Please enter the full informations!",mainView,loader);
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
         ...
         //   GenericHelper.createAndShowAlert(Alert.AlertType.INFORMATION,"Succes", newTodoItem.getDescription());

        }
        else {
            GenericHelper.createAndShowAlert(Alert.AlertType.INFORMATION,"pishman", "Nuk po don e regjistru");
        }
    }
}
